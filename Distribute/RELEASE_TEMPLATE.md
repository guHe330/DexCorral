...
- Desktop sorting is now owned by DexCorral (Fences-style): "Sort by" never moves corral-owned icons and no longer leaves empty grid slots where hidden icons used to be
